...
class RRT:
    ...
    def draw_lines(self, p1, p2):
        bpy.ops.surface.primitive_nurbs_surface_sphere_add(radius=.1, location=p1)
        #bpy.ops.surface.primitive_nurbs_surface_sphere_add(radius=.05, location=(-1, -1, 0))
        bpy.ops.surface.primitive_nurbs_surface_sphere_add(radius=.1, location=p2)
